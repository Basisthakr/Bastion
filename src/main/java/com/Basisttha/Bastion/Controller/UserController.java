...
public class UserController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<SearchResponse>> search(@Valid @RequestParam String username) {
        return ResponseEntity.ok().body(userService.userSearchResponse(new SearchRequest(username)));
    }
}
